...
chain_file = os.path.join(dirname, "./like/like_LSST_ggl_cl_noredshifterr_nuisance")
...
sample_params = sample_cosmology_ggl_clustering_nuisance(get_N_tomo_shear(),get_N_tomo_clustering(), MG=True)
