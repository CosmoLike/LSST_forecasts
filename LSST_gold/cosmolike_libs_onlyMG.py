...
class InputNuisanceParams(IterableStruct):
    ...
    def setup(cls):
        ...
        c.A_ia = get_nuisance_A_ia()
        c.beta_ia = get_nuisance_beta_ia()
        c.eta_ia = get_nuisance_eta_ia()
...
def sample_cosmology_only(MGonly = False):
    if MGonly:
        varied_parameters = ["MGSigma", "MGmu"]
    else:
