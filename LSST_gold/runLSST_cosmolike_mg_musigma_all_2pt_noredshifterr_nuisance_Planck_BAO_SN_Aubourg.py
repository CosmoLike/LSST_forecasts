...
chain_file = os.path.join(dirname, "./like/like_LSST_all_2pt_noredshifterr_nuisance_Planck_BAO_SN_Aubourg_zmin0.15_smallerstd")
...
initclusters()
initia("none","DEEP2")
initpriors("Planck_BAO_SN_Aubourg","none","none","none")
...
sample_main(sample_params,16000,128,24,chain_file, blind=False)
