...
cov_file = os.path.join(dirname, "cov/Multi_Probe_LSST_2.600000e+01_1.800000e+04_Rmin10_lmin30_lens-zmin0.15LSST_cov_Ncl20_Ntomo10_shear_inv")
chain_file = os.path.join(dirname, "./like/like_LSST_shear_shear_noredshifterr_zmin0.15_3")
