...
int main(int argc, char** argv)
{
  ...
  // int ktable[16]={6646,6273,6274,6275,6291,4012,4013,4028,4039,4061,4510,4511,4713,4714,4732,4733};
  // int hit=ktable[atoi(argv[1])-1];
  int hit=atoi(argv[1]);
  ...
  init_survey("LSST");
  //  init_galaxies("../../zdistris/zdistribution_LSST","../../zdistris/zdistribution_LSST_gold", "gaussian", "gaussian", "gold");
  init_galaxies("../../cosmolike_core/zdistris/zdistribution_LSST","../../cosmolike_core/zdistris/zdistribution_LSST_gold", "none", "none", "gold");
  init_clusters();
  init_IA("none", "DEEP2");
  init_probes("all_2pt");
  for (i=0;i<10; i++){
  ...
  sprintf(PATH,"/nobackup0/sunglass/hironaom/covparallel/Multi_Probe_LSST_%le_%le_Rmin10_lmin30_lens",survey.n_gal,survey.area);
