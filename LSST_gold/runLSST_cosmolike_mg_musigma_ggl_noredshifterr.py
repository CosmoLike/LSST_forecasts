...
data_file = os.path.join(dirname, "datav/LSST_ggl_fid")
cov_file = os.path.join(dirname, "cov/Multi_Probe_LSST_2.600000e+01_1.800000e+04_Rmin10_lmin30_lens-zmin0.15LSST_cov_Ncl20_Ntomo10_ggl_inv")
chain_file = os.path.join(dirname, "./like/like_LSST_ggl_noredshifterr")
...
sample_main(sample_params,8000,128,24,chain_file, blind=False)
