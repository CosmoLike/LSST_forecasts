...
chain_file = os.path.join(dirname, "./like/like_LSST_all_2pt_noredshifterr_nuisance_zmin0.15_smallerstd")
...
#sample_main(sample_params,4000,128,24,chain_file, blind=False)
